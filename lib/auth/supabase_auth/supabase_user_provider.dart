...
class VikyappSupabaseUser extends BaseAuthUser {
  VikyappSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> vikyappSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = VikyappSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
