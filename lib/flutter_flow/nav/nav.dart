...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/appointments',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'Appointments')
        ...
        FFRoute(
          name: 'alldoctors',
          path: '/alldoctors',
          builder: (context, params) => const AlldoctorsWidget(),
        ),
        FFRoute(
          name: 'alllabs',
          path: '/alllabs',
          builder: (context, params) => const AlllabsWidget(),
        ),
        FFRoute(
          name: 'allpharmacies',
          path: '/allpharmacies',
          builder: (context, params) => const AllpharmaciesWidget(),
        ),
        FFRoute(
          name: 'messages',
          path: '/messages',
        ...
        FFRoute(
          ...
          builder: (context, params) => const PaymentConfirmedWidget(),
        ),
        FFRoute(
          name: 'editprofile',
          path: '/editprofile',
